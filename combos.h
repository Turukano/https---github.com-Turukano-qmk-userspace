...
const uint16_t PROGMEM quit[] = {KC_H, LT(0,KC_L), KC_M, KC_W, COMBO_END}; //close app
...
const uint16_t PROGMEM escaping[] = {LT(0,KC_J), KC_D, COMBO_END};
const uint16_t PROGMEM nein[] = {KC_D,        LT(0,KC_U), COMBO_END};
const uint16_t PROGMEM deleting[] = {KC_M, KC_W, COMBO_END};
const uint16_t PROGMEM boot[] = {KC_F, LT(0,KC_J), COMBO_END};
...
const uint16_t PROGMEM ctab[] = {KC_LEFT, KC_DOWN, KC_RGHT, LT(1,KC_END), COMBO_END};//close tab
...
combo_t key_combos[] = {
    ...
    [SELLINEB] = COMBO(sellineb, S(KC_HOME)), 
    [SELLINEF] = COMBO(sellinef, S(KC_END)), 
